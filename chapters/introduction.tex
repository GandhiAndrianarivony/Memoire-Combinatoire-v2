...
% Dans le présent mémoire, qui est inspiré de \cite{RRP}, le nombre de Fine d'ordre $n$ est désigné par $F_{n}$. 
Dans le présent mémoire, on notera par $C_{n}$ le nombre de Catalan d'ordre $n$ et on notera par $\text{RS}_{n}$, respectivement $S_{n}$, l'ensemble des relations de similarité, respectivement des permutations, sur l'ensemble $\{1, 2, \cdots, n\}$.\\
...
Dans un premier temps, nous introduisons les relations de similarité.

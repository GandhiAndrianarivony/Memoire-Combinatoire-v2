...
\[
	\begin{array}{r c l}
		\phi(x,z) & = & \cfrac{1-x+C(z)}{2-x+z(x-1)^{2}}                                                                                                                                    \\
		          ...
		          & = & [C(z)-(x-1)]\cfrac{1}{2-x}\underset{p\geq0}{\sum}(-1)^p\cfrac{(x-1)^{2p}}{(2-x)^p}t^p                                                                               \\
...
On pose $s(z)=\underset{n\geq 0}{\sum}s_{n}^{1}(\alpha)z^{n}$. Comme $F_{n}^{0} = s_{n}^{0}(\alpha)=F_{n}$, alors
%et $F_{n-1}^{0}=F_{n}$ alors
%et $F_{n}^{1}=s_{n}^{1}$, alors
\[
	\underset{n\geq 1}{\sum}2F_{n}^{1}z^n + \underset{n\geq 1}{\sum}F_{n-1}^{1}z^n = \underset{n\geq 1}{\sum}F_{n}^{0}z^n + \underset{n\geq 1}{\sum}2F_{n-1}^{0}z^n
\]
D'où

...
En conséquent, $C(z)=\cfrac{1-\sqrt{1-4z}}{2z}$ \hspace{5pt}$\blacksquare$
...
\begin{corollaire}
	On a $|\Gamma_{n}|=C_{n}$.
\end{corollaire}
Preuve: De ce qu'on voit dans la \Cref{cat-frac} et dans la \Cref{gamma-frac}, $C(z)$ et $\Gamma(z)$ ont le même développement en fraction continue.\\
